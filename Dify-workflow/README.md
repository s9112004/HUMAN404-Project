...
![image](https://github.com/s9112004/HUMAN404-Project/blob/Dify-workflow/Dify-workflow/Pictures/LocalDify-4-Import.png)

5. 點最上方的「Tools」，選擇頁面左上「Custom」，並點「Create Custom Tool」。
![image](https://github.com/s9112004/HUMAN404-Project/blob/Dify-workflow/Dify-workflow/Pictures/LocalDify-5-Create.png)

6. 輸入工具名稱，並將「mcp-tools.json」中的程式碼複製貼上至第二區Schema的區塊。最後按下建立。(這個工具應該不能用，因為目前EC2上的是直接透過內網傳輸，外網若要連接需要詢問Jason)
![image](https://github.com/s9112004/HUMAN404-Project/blob/Dify-workflow/Dify-workflow/Pictures/LocalDify-6-Add.png)
